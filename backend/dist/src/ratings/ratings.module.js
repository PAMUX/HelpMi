...
const ratings_controller_js_1 = require("./ratings.controller.js");
let RatingsModule = class RatingsModule {
};
exports.RatingsModule = RatingsModule;
exports.RatingsModule = RatingsModule = __decorate([
    (0, common_1.Module)({
        providers: [ratings_service_js_1.RatingsService],
        controllers: [ratings_controller_js_1.RatingsController],
    })
], RatingsModule);
